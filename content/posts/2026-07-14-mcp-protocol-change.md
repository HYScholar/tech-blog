---\ntitle: "MCP 协议史上最大变更——2026年7月28日倒计时，4356个服务器仅1个做好准备"\ndate: "2026-07-14"\ntags: ["MCP", "Agent", "协议", "Anthropic", "开源", "工程化"]\ncategories: ["技术"]\nauthor: "HYScholar"\ndraft: false\n---\n# MCP 协议史上最大变更——2026年7月28日倒计时，4356 个服务器仅 1 个做好准备

2026 年 7 月 12 日，一位开发者跑了个脚本：用 `mcp-spec-check` 扫了官方 Registry 上 4356 个可访问的 MCP 服务器。结果是 1 个通过。不是 1%，是 1 个。

焦虑蔓延得很快。Hacker News 帖子冲上了首页，有人类比「以太坊 Merge 级别的硬分叉」，有人开始列「7 月 28 日之后会挂掉的服务器清单」。

但实际情况没那么吓人。这个数字不是崩溃倒计时，是一张「之前」的快照——规范还没正式发布，deprecated 功能至少还能活 12 个月，不通过 ≠ 不可用。不过这次协议变更的量级确实配得上「史上最大」这个说法。如果你在用 MCP 做 Agent 开发，或者在维护 MCP 服务器，有件事值得搞清楚：到底改了什么，为什么改，以及你该什么时候动手。
